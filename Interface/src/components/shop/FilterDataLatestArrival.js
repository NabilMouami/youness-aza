...
import ShopCardLatestArrival from "./ShopCardLatestArrival";

const FilterDataLatestArrival = ({
  status,
  showItem,
  showPagination,
  filterData,
        ...
        <>
          {getPaginatedProducts.map((item) => (
            <Fragment key={item.id}>
              <ShopCardLatestArrival status={status} item={item} />
            </Fragment>
          ))}
...
export default FilterDataLatestArrival;
