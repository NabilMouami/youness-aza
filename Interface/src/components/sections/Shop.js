            ...
            <div className="col-md-12">
              <div className="tpsectionarea text-center mb-35">
                ...
                <h4 className="tpsectionarea__title">
                  <i className="fab fa-instagram" /> yaza sneakers
                </h4>
              </div>
            </div>
          </div>
              ...
              <Swiper {...swiperOptions}>
                <SwiperSlide className="tpshopitem">
                  <Link className="popup-image" href="#">
                    <img
                      src="/assets/img/instagram/instagram-01.jpg"
                      alt="shop-thumb"
                    />
                  </Link>
                </SwiperSlide>
                <SwiperSlide className="tpshopitem">
                  <Link className="popup-image" href="#">
                    <img
                      src="/assets/img/instagram/instagram-02.jpg"
                      alt="shop-thumb"
                    />
                  </Link>
                </SwiperSlide>
                <SwiperSlide className="tpshopitem">
                  <Link className="popup-image" href="#">
                    <img
                      src="/assets/img/instagram/instagram-03.jpg"
                      alt="shop-thumb"
                    />
                  </Link>
                </SwiperSlide>
                <SwiperSlide className="tpshopitem">
                  <Link className="popup-image" href="#">
                    <img
                      src="/assets/img/instagram/instagram-04.jpg"
                      alt="shop-thumb"
                    />
                  </Link>
                </SwiperSlide>
                <SwiperSlide className="tpshopitem">
                  <Link className="popup-image" href="#">
                    <img
                      src="/assets/img/instagram/instagram-05.jpg"
                      alt="shop-thumb"
                    />
                  </Link>
                </SwiperSlide>
                <SwiperSlide className="tpshopitem">
                  <Link className="popup-image" href="#">
                    <img
                      src="/assets/img/instagram/instagram-06.jpg"
                      alt="shop-thumb"
                    />
                  </Link>
                </SwiperSlide>
