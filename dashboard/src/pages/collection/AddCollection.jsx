  ...
  const handleUpload = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${config_url}/api/create-collection`,
        formdata,
        {
          headers: {
      ...
      if (response.status === 200)
        toast.success("Ajoute Collection Success !!", {
          position: "top-right",
        });
      setLoading(false);
    } catch (error) {
  ...
  return (
    <Fragment>
      <div className="page__main">
        ...
        >
          <span className="pl-2 mx-1">Page Of Add Collection</span>
        </button>
        ...
        >
          <h1 className="text-center">Information sur Collection:</h1>
