...
function UpdCollection({ closeModal, rowCategory, categories, setCategories }) {
  ...
  const handleChange = async () => {
    ...
    try {
      const response = await axios.put(
        `${config_url}/api/update-collection/${rowCategory.id}`,
      ...
      if (response.status === 200) {
        ...
        toast.success("Changement Collection Success !!", {
          position: "top-right",
        });
        closeModal();
      }
